...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["team-team-module"], {
  ...
  function srcAppTeamTeamComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function TeamComponent_div_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TeamComponent_div_7_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 2);
    ...
    TeamComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 8,
      vars: 2,
      consts: [[1, "teamContainer"], ["class", "col-6 col-md-4 col-lg-3", 4, "ngFor", "ngForOf"], [1, "col-6", "col-md-4", "col-lg-3"], [1, "padding"], [1, "image", 3, "src"], [1, "name"], [1, "title"]],
