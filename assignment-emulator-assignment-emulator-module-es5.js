...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["assignment-emulator-assignment-emulator-module"], {
  /***/
  ...
  function node_modulesAngularResizableElement__ivy_ngcc__Fesm2015AngularResizableElementJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(ResizableDirective, [{
        ...
        value: function ngOnInit() {
          ...
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["auditTime"])(MOUSE_MOVE_THROTTLE_MS), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.destroy$)).subscribe(function (_ref6) {
    ...
    ResizeHandleDirective.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineDirective"]({
      ...
      hostBindings: function ResizeHandleDirective_HostBindings(rf, ctx, elIndex) {
        if (rf & 1) {
  ...
  /*! exports provided: FunctionsUsingCSI, KindOfEraseInDisplay, KindOfEraseInLine, NgTerminalComponent, NgTerminalModule, NgTerminalService, ɵa */

  /***/
  function node_modulesNgTerminal__ivy_ngcc__Fesm2015NgTerminalJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FunctionsUsingCSI", function () {
      return FunctionsUsingCSI;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "KindOfEraseInDisplay", function () {
      return KindOfEraseInDisplay;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "KindOfEraseInLine", function () {
      return KindOfEraseInLine;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "NgTerminalComponent", function () {
      return NgTerminalComponent;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "NgTerminalModule", function () {
      return NgTerminalModule;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "NgTerminalService", function () {
    ...
    var xterm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! xterm */
    "./node_modules/xterm/lib/xterm.js");
    /* harmony import */


    var xterm__WEBPACK_IMPORTED_MODULE_1___default =
    /*#__PURE__*/
    __webpack_require__.n(xterm__WEBPACK_IMPORTED_MODULE_1__);
    /* harmony import */


    var xterm_addon_fit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! xterm-addon-fit */
    "./node_modules/xterm-addon-fit/lib/xterm-addon-fit.js");
    /* harmony import */


    var xterm_addon_fit__WEBPACK_IMPORTED_MODULE_2___default =
    /*#__PURE__*/
    __webpack_require__.n(xterm_addon_fit__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */
    ...
    var NgTerminalService = function NgTerminalService() {
      _classCallCheck(this, NgTerminalService);
    };
    ...
    NgTerminalService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
    ...
    NgTerminalService.ctorParameters = function () {
      return [];
    };
    /** @nocollapse */


    NgTerminalService.ngInjectableDef = Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["defineInjectable"])({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NgTerminalService, [{
    ...
    var NgTerminalComponent =
    /*#__PURE__*/
    function () {
      function NgTerminalComponent() {
        _classCallCheck(this, NgTerminalComponent);

        this.keyInputSubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        this.keyEventSubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        this.h = Math.max(document.documentElement.clientHeight, window.innerHeight || 0);
        this.displayOption = {};
        this.terminalStyle = {};
        this.keyInputEmitter = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.keyEventEmitter = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
      }
      /**
       * @param {?} ds
       * @return {?}
      ...
      _createClass(NgTerminalComponent, [{
        key: "observableSetup",
         ...
         * @return {?}
         */
        value: function observableSetup() {
          var _this5 = this;
          ...
          */
          function (input) {
            _this5.keyInputSubject.next(input);
          });
          this.term.onKey(
          /**
          * @param {?} e
          ...
          */
          function (data) {
            _this5.keyInputEmitter.emit(data);
          });
        ...
        key: "setTerminalBlock",
        value: function setTerminalBlock(isBlock) {
        ...
        key: "setTerminalDimension",
        value: function setTerminalDimension(left, top, width, height) {
          this.terminalStyle['left'] = "".concat(left, "px");
          this.terminalStyle['top'] = "".concat(top, "px");
          this.terminalStyle['width'] = "".concat(width, "px");
          this.terminalStyle['height'] = "".concat(height, "px");
        }
        /**
         * remove dimensions
         * @private
        ...
        key: "removeTerminalDimension",
        value: function removeTerminalDimension() {
        ...
        value: function ngAfterViewChecked() {
          if (this.displayOption.fixedGrid == null) this.fitAddon.fit();
        }
        /**
        ...
        key: "setDisplayOption",
        value: function setDisplayOption(opt) {
         ...
         * @return {?}
         */
        value: function onResizeEnd(left, top, width, height) {
        ...
        value: function validatorFactory() {
          /** @type {?} */
          var comp = this;
          return (
            /**
        ...
        key: "isDraggableOnEdgeActivated",
        get: function get() {
    ...
    NgTerminalComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      viewQuery: function NgTerminalComponent_Query(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵloadQuery"]()) && (ctx.terminalDiv = _t.first);
        }
      },
      inputs: {
      ...
      template: function NgTerminalComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "global-style");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 0, 1);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("resizeEnd", function NgTerminalComponent_Template_div_resizeEnd_1_listener($event) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngStyle", ctx.terminalStyle)("validateResize", ctx.validatorFactory())("enableGhostResize", true)("resizeEdges", ctx.isDraggableOnEdgeActivated ? _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction0"](4, _c1) : _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction0"](5, _c2));
        }
      },
      directives: function directives() {
        return [GlobalStyleComponent, angular_resizable_element__WEBPACK_IMPORTED_MODULE_4__["ResizableDirective"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgStyle"]];
      },
      styles: [".terminal-outer[_ngcontent-%COMP%]{box-sizing:border-box;border:3px solid #429bf4;height:100%}"]
    });
    /** @nocollapse */

    NgTerminalComponent.ctorParameters = function () {
      return [];
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NgTerminalComponent, [{
    ...
    GlobalStyleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
    ...
    GlobalStyleComponent.ctorParameters = function () {
      return [];
    };
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GlobalStyleComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
    ...
    var NgTerminalModule = function NgTerminalModule() {
      _classCallCheck(this, NgTerminalModule);
    };

    NgTerminalModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: NgTerminalModule
    });
    NgTerminalModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function NgTerminalModule_Factory(t) {
        return new (t || NgTerminalModule)();
      },
      imports: [[angular_resizable_element__WEBPACK_IMPORTED_MODULE_4__["ResizableModule"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["CommonModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](NgTerminalModule, {
        declarations: function declarations() {
          return [NgTerminalComponent, GlobalStyleComponent];
        },
        imports: function imports() {
          return [angular_resizable_element__WEBPACK_IMPORTED_MODULE_4__["ResizableModule"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["CommonModule"]];
        },
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NgTerminalModule, [{
    ...
    var FunctionsUsingCSI =
    /*#__PURE__*/
    function () {
      function FunctionsUsingCSI() {
        _classCallCheck(this, FunctionsUsingCSI);
      }

      _createClass(FunctionsUsingCSI, null, [{
        key: "insertBlank",
         ...
         * @return {?}
         */
        value: function insertBlank(count) {
          return "".concat(CSI).concat(count, "@");
        }
        /**
             *  CSI Ps SP @ */
        ...
        key: "cursorDown",
        value: function cursorDown(count) {
        ...
        key: "cursorForward",
        value: function cursorForward(count) {
        ...
        key: "cursorBackward",
        value: function cursorBackward(count) {
        ...
        key: "cursorNextLine",
        value: function cursorNextLine(count) {
          return "".concat(CSI).concat(count, "E");
        }
        /**
        ...
        value: function cursorPrecedingLine(count) {
          return "".concat(CSI).concat(count, "F");
        }
        /**
        ...
        key: "cursorColumn",
        value: function cursorColumn(count) {
          return "".concat(CSI).concat(count, "G");
        }
        /**
        ...
        key: "cursorPosition",
        value: function cursorPosition(row, col) {
          return "".concat(CSI).concat(row, ";").concat(col, "H");
        }
        /**
        ...
        key: "eraseInDisplay",
        value: function eraseInDisplay(category) {
          return "".concat(CSI).concat(category, "J");
        }
        /**
         *  CSI ? Ps J
        ...
        key: "eraseSelectiveThingsInDisplay",
        value: function eraseSelectiveThingsInDisplay(category) {
          return "".concat(CSI, "?").concat(category, "J");
        }
        /**
         *  CSI Ps K
        ...
        key: "eraseInLine",
        value: function eraseInLine(category) {
          return "".concat(CSI).concat(category, "K");
        }
        /**
         *  CSI ? Ps K
        ...
        key: "eraseSelectiveThingsInLine",
        value: function eraseSelectiveThingsInLine(category) {
          return "".concat(CSI, "?").concat(category, "K");
        }
        /**
        ...
        key: "insertLines",
        value: function insertLines(count) {
          return "".concat(CSI).concat(count, "L");
        }
        /**
        ...
        key: "deleteLines",
        value: function deleteLines(count) {
          return "".concat(CSI).concat(count, "M");
        }
        /**
        ...
        key: "deleteCharacter",
        value: function deleteCharacter(count) {
          return "".concat(CSI).concat(count, "P");
        }
        /**
        ...
        key: "scrollUpLines",
        value: function scrollUpLines(count) {
          return "".concat(CSI).concat(count, "S");
        }
        /**
             *  CSI ? Pi ; Pa ; Pv S */
        ...
        key: "scrollDownLines",
        value: function scrollDownLines(count) {
          return "".concat(CSI).concat(count, "T");
        }
        /**
        ...
        key: "eraseCharacters",
        value: function eraseCharacters(count) {
          return "".concat(CSI).concat(count, "X");
        }
      }]);
  ...
  /***/
  function node_modulesXtermAddonFitLibXtermAddonFitJs(module, exports, __webpack_require__) {
    !function (e, t) {
  ...
  /***/
  function node_modulesXtermLibXtermJs(module, exports, __webpack_require__) {
    !function (e, t) {
      ...
      return function (e) {
        ...
        var i = function () {
          ...
          return Object.defineProperty(e.prototype, "event", {
            ...
            for (var t = [], r = 0; r < this._listeners.length; r++) {
              t.push(this._listeners[r]);
            }
        ...
        function f(e, t, r) {
          for (var i = e >> 24 & 255, n = e >> 16 & 255, o = e >> 8 & 255, s = t >> 24 & 255, a = t >> 16 & 255, h = t >> 8 & 255, u = l(c(s, h, a), c(i, n, o)); u < r && (s > 0 || a > 0 || h > 0);) {
            s -= Math.max(0, Math.ceil(.1 * s)), a -= Math.max(0, Math.ceil(.1 * a)), u = l(c(s, h -= Math.max(0, Math.ceil(.1 * h)), a), c(i, n, o));
          }
        ...
        function _(e, t, r) {
          for (var i = e >> 24 & 255, n = e >> 16 & 255, o = e >> 8 & 255, s = t >> 24 & 255, a = t >> 16 & 255, h = t >> 8 & 255, u = l(c(s, h, a), c(i, n, o)); u < r && (s < 255 || a < 255 || h < 255);) {
            s = Math.min(255, s + Math.ceil(.1 * (255 - s))), a = Math.min(255, a + Math.ceil(.1 * (255 - a))), u = l(c(s, h = Math.min(255, h + Math.ceil(.1 * (255 - h))), a), c(i, n, o));
          }
        ...
        var i = r(3),
          ...
          return e.prototype.dispose = function () {
            ...
            if (this._ctx.save(), this._ctx.font = this._getFont(!!e.isBold(), !!e.isItalic()), this._ctx.textBaseline = "middle", e.isInverse()) {
              if (i) this._ctx.fillStyle = i.css;else if (e.isBgDefault()) this._ctx.fillStyle = c.opaque(this._colors.background).css;else if (e.isBgRGB()) this._ctx.fillStyle = "rgb(" + s.AttributeData.toColorRGB(e.getBgColor()).join(",") + ")";else {
                var o = e.getBgColor();
        ...
        var c = function () {
          ...
          return e.prototype.get = function (e) {
            ...
            if (e %= this.length, t < this.length - e) {
              for (var i = new o.CellData(), n = this.length - e - t - 1; n >= 0; --n) {
                this.setCell(e + t + n, this.loadCell(e + n, i));
              }

              for (n = 0; n < t; ++n) {
                this.setCell(e + n, r);
              }
            } else for (n = e; n < this.length; ++n) {
              this.setCell(n, r);
            }
          }, e.prototype.deleteCells = function (e, t, r) {
            if (e %= this.length, t < this.length - e) {
              for (var i = new o.CellData(), n = 0; n < this.length - e - t; ++n) {
                this.setCell(e + n, this.loadCell(e + t + n, i));
              }
        ...
        var o = r(35),
          ...
          return n(t, e), Object.defineProperty(t.prototype, "options", {
            ...
            var t = function t(_t2) {
              return a.handlePasteEvent(_t2, e.textarea, e.bracketedPasteMode, e._coreService);
            };
            ...
            if (0 !== this.buffer.ybase || 0 !== this.buffer.y) {
              ...
              for (var e = 1; e < this.rows; e++) {
                this.buffer.lines.push(this.buffer.getBlankLine(S.DEFAULT_ATTR_DATA));
              }
          ...
          return n(t, e), Object.defineProperty(t.prototype, "onCursorMove", {
            ...
            for (var v = t; v < r; ++v) {
              ...
              if (c && this._terminal.onA11yCharEmitter.fire(u.stringFromCodePoint(i)), n || !o.x) {
                if (o.x + n - 1 >= l) if (h) o.x = 0, o.y++, o.y === o.scrollBottom + 1 ? (o.y--, this._terminal.scroll(!0)) : (o.y >= this._bufferService.rows && (o.y = this._bufferService.rows - 1), o.lines.get(o.y).isWrapped = !0), p = o.lines.get(o.y + o.ybase);else if (o.x = l - 1, 2 === n) continue;
                if (f && (p.insertCells(o.x, n, o.getNullCell(_)), 2 === p.getWidth(l - 1) && p.setCellFromCodePoint(l - 1, d.NULL_CELL_CODE, d.NULL_CELL_WIDTH, _.fg, _.bg)), p.setCellFromCodePoint(o.x++, i, n, _.fg, _.bg), n > 0) for (; --n;) {
                  p.setCellFromCodePoint(o.x++, 0, 0, _.fg, _.bg);
                }
            ...
            if (!(r.y > r.scrollBottom || r.y < r.scrollTop)) {
              for (var i = r.y + r.ybase, n = this._bufferService.rows - 1 - r.scrollBottom, o = this._bufferService.rows - 1 + r.ybase - n + 1; t--;) {
                r.lines.splice(o - 1, 1), r.lines.splice(i, 0, r.getBlankLine(this._terminal.eraseAttrData()));
              }
            ...
            if (!(r.y > r.scrollBottom || r.y < r.scrollTop)) {
              ...
              for (i = this._bufferService.rows - 1 - r.scrollBottom, i = this._bufferService.rows - 1 + r.ybase - i; t--;) {
                r.lines.splice(n, 1), r.lines.splice(i, 0, r.getBlankLine(this._terminal.eraseAttrData()));
              }
            ...
            for (var t = e.params[0] || 1, r = this._bufferService.buffer; t--;) {
              r.lines.splice(r.ybase + r.scrollTop, 1), r.lines.splice(r.ybase + r.scrollBottom, 0, r.getBlankLine(this._terminal.eraseAttrData()));
            }

            this._dirtyRowService.markRangeDirty(r.scrollTop, r.scrollBottom);
          }, t.prototype.scrollDown = function (e) {
            for (var t = e.params[0] || 1, r = this._bufferService.buffer; t--;) {
              r.lines.splice(r.ybase + r.scrollBottom, 1), r.lines.splice(r.ybase + r.scrollTop, 0, r.getBlankLine(f.DEFAULT_ATTR_DATA));
            }
        ...
        var o = r(13),
          ...
          return n(t, e), t.prototype.resize = function (t) {
            ...
            if (this._coreService.isCursorInitialized && !this._coreService.isCursorHidden) {
              ...
              if (r < 0 || r >= this._bufferService.rows) this._clearCursor();else if (this._bufferService.buffer.lines.get(t).loadCell(this._bufferService.buffer.x, this._cell), void 0 !== this._cell.content) {
        ...
        var s = function s(e, t, r, i, n, o, _s2, a, c) {
          this.x1 = e, this.y1 = t, this.x2 = r, this.y2 = i, this.clickCallback = n, this.hoverCallback = o, this.tooltipCallback = _s2, this.leaveCallback = a, this.willLinkActivate = c;
        };
        ...
        t.handleWindowsModeLineFeed = function (e) {
          var t,
              r = null === (t = e.buffer.lines.get(e.buffer.ybase + e.buffer.y - 1)) || void 0 === t ? void 0 : t.get(e.cols - 1),
        ...
        var _i19,
            n = this && this.__extends || (_i19 = function i(e, t) {
          ...
          _i19(e, t), e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r());
        });
  ...
  /***/
  "./src/app/assignment-emulator/assignment-emulator-routing.module.ts":
  /*!***************************************************************************!*\
    !*** ./src/app/assignment-emulator/assignment-emulator-routing.module.ts ***!
    \***************************************************************************/

  /*! exports provided: AssignmentEmulatorRoutingModule */

  /***/
  function srcAppAssignmentEmulatorAssignmentEmulatorRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AssignmentEmulatorRoutingModule", function () {
      return AssignmentEmulatorRoutingModule;
    });
    /* harmony import */
    ...
    var _components_console_assignment_console_assignment_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./components/console-assignment/console-assignment.component */
    "./src/app/assignment-emulator/components/console-assignment/console-assignment.component.ts");

    var routes = [{
      path: ':key',
      component: _components_console_assignment_console_assignment_component__WEBPACK_IMPORTED_MODULE_2__["ConsoleAssignmentComponent"],
      pathMatch: 'full'
    }];

    var AssignmentEmulatorRoutingModule = function AssignmentEmulatorRoutingModule() {
      _classCallCheck(this, AssignmentEmulatorRoutingModule);
    };

    AssignmentEmulatorRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: AssignmentEmulatorRoutingModule
    });
    AssignmentEmulatorRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function AssignmentEmulatorRoutingModule_Factory(t) {
        return new (t || AssignmentEmulatorRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AssignmentEmulatorRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AssignmentEmulatorRoutingModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
  ...
  /***/
  "./src/app/assignment-emulator/assignment-emulator.module.ts":
  /*!*******************************************************************!*\
    !*** ./src/app/assignment-emulator/assignment-emulator.module.ts ***!
    \*******************************************************************/

  /*! exports provided: AssignmentEmulatorModule */

  /***/
  function srcAppAssignmentEmulatorAssignmentEmulatorModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AssignmentEmulatorModule", function () {
      return AssignmentEmulatorModule;
    });
    /* harmony import */
    ...
    var _assignment_emulator_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./assignment-emulator-routing.module */
    "./src/app/assignment-emulator/assignment-emulator-routing.module.ts");
    /* harmony import */


    var _components_console_assignment_console_assignment_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./components/console-assignment/console-assignment.component */
    "./src/app/assignment-emulator/components/console-assignment/console-assignment.component.ts");
    /* harmony import */
    ...
    var ng_terminal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ng-terminal */
    "./node_modules/ng-terminal/__ivy_ngcc__/fesm2015/ng-terminal.js");

    var AssignmentEmulatorModule = function AssignmentEmulatorModule() {
      _classCallCheck(this, AssignmentEmulatorModule);
    };

    AssignmentEmulatorModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: AssignmentEmulatorModule
    });
    AssignmentEmulatorModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function AssignmentEmulatorModule_Factory(t) {
        return new (t || AssignmentEmulatorModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _assignment_emulator_routing_module__WEBPACK_IMPORTED_MODULE_2__["AssignmentEmulatorRoutingModule"], _material_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], ng_terminal__WEBPACK_IMPORTED_MODULE_5__["NgTerminalModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AssignmentEmulatorModule, {
        declarations: [_components_console_assignment_console_assignment_component__WEBPACK_IMPORTED_MODULE_3__["ConsoleAssignmentComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _assignment_emulator_routing_module__WEBPACK_IMPORTED_MODULE_2__["AssignmentEmulatorRoutingModule"], _material_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], ng_terminal__WEBPACK_IMPORTED_MODULE_5__["NgTerminalModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AssignmentEmulatorModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          declarations: [_components_console_assignment_console_assignment_component__WEBPACK_IMPORTED_MODULE_3__["ConsoleAssignmentComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _assignment_emulator_routing_module__WEBPACK_IMPORTED_MODULE_2__["AssignmentEmulatorRoutingModule"], _material_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"], ng_terminal__WEBPACK_IMPORTED_MODULE_5__["NgTerminalModule"]]
  ...
  /*! exports provided: ConsoleAssignmentComponent */

  /***/
  function srcAppAssignmentEmulatorComponentsConsoleAssignmentConsoleAssignmentComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ConsoleAssignmentComponent", function () {
      return ConsoleAssignmentComponent;
    });
    /* harmony import */
    ...
    var ConsoleAssignmentComponent =
    /*#__PURE__*/
    function () {
      function ConsoleAssignmentComponent(_route) {
        _classCallCheck(this, ConsoleAssignmentComponent);

        this._route = _route;
      }

      _createClass(ConsoleAssignmentComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this7 = this;

          this.lastInputSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();

          this._route.paramMap.subscribe(function (params) {
            _this7.key = params.get('key');
          });
        }
      }, {
        key: "ngAfterViewInit",
        value: function ngAfterViewInit() {
          ...
          this.terminal.keyEventInput.subscribe(function (e) {
            var ev = e.domEvent;
            var printable = !ev.altKey && !ev.ctrlKey && !ev.metaKey;

            if (ev.key === 'ArrowUp' || ev.key === 'ArrowDown' || ev.key === 'ArrowLeft' || ev.key === 'ArrowRight') {// arrow keys are not allowed
            } else if (ev.key === 'Enter') {
              _this8.terminal.write('\r\n');

              _this8.lastInputSubject.next(_this8.lastInput);

              _this8.lastInput = '';
              _this8.lastLinePrintYPosition = 0;
            } else if (ev.key === 'Backspace') {
              if (_this8.terminal.underlying.buffer.cursorX > _this8.lastLinePrintYPosition) {
                _this8.terminal.write('\b \b');

                _this8.lastInput = _this8.lastInput.substring(0, _this8.lastInput.length - 1);
              }
            } else if (printable) {
              _this8.terminal.write(e.key);

              if (ev.key.length === 1) {
                _this8.lastInput += ev.key;
              }
            }
          });
        ...
        key: "assignment1A",
        value: function assignment1A() {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0,
          /*#__PURE__*/
          regeneratorRuntime.mark(function _callee2() {
            var _this9 = this;

            var total_amount, offer, answer;
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    total_amount = 10;
                    this.printToTerminal("The proposer is given $".concat(total_amount));
                    ...
                    this.printToTerminal('If the responder accepts, both proposer and responder receive payoffs according to the proposed allocation.');
                    ...
                    _context2.next = 13;
                    return this.takeInputFromTerminal("Proposer, how much do you want to offer to the responder from $".concat(total_amount, ": "));

                  case 13:
                    offer = _context2.sent;

                  case 14:
                    if (!(isNaN(+offer) || +offer > total_amount || +offer < 0)) {
                      _context2.next = 21;
                      break;
                    }
                  ...
                  case 21:
                    _context2.next = 23;
                    return this.takeInputFromTerminal("Responder, do you accept the proposer's offer of taking $".concat(offer, " from $").concat(total_amount, ": "));
                  ...
                  case 31:
                    if (answer === 'yes') {
                      this.printToTerminal("The responder has accepted the offer, the proposer gets $".concat(offer, " and the responder gets $").concat(total_amount - +offer, "."));
                    } else {
                      this.printToTerminal('The responder rejected the offer, both the proposer and the responder gets $0.');
                    }

                    _context2.next = 34;
                    return this.takeInputFromTerminal('Enter any value to restart the game: ');
        ...
        key: "assignment1B",
        value: function assignment1B() {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0,
          /*#__PURE__*/
          regeneratorRuntime.mark(function _callee4() {
            var _this10 = this;

            var valuationA, valuationB, bidA, bidB;
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    this.printToTerminal('Each bidder (Player A and Player B) is privately assigned a random "valuation" for the item between 1 and 10.');
                    ...
                    valuationA = this.getRandomInt(1, 11);
                    valuationB = this.getRandomInt(1, 11);
                    _context4.next = 12;
                    return this.assignment1BPlayerA(valuationA);

                  case 12:
                    bidA = _context4.sent;
                    _context4.next = 15;
                    return this.assignment1BPlayerB(valuationB);
                  ...
                  case 15:
                    ...
                    if (bidA > bidB) {
                      ...
                      this.printToTerminal("Player A received ".concat(valuationA - bidA, " payoff and Player B received 0 payoff."));
                    } else if (bidB > bidA) {
                      this.printToTerminal('Player B won the auction.');
                      this.printToTerminal("Player B received ".concat(valuationB - bidB, " payoff and Player A received 0 payoff."));
                    } else {
        ...
        key: "assignment1BPlayerA",
        value: function assignment1BPlayerA(valuationA) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0,
          /*#__PURE__*/
            ...
            return regeneratorRuntime.wrap(function _callee5$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    this.printToTerminal("Player A, you are assigned the random valuation of ".concat(valuationA, "."));
                    _context5.next = 3;
                    return this.takeInputFromTerminal('How much would you like to bid?: ');

                  case 3:
                    bidA = _context5.sent;

                  case 4:
                    if (!(isNaN(+bidA) || +bidA > valuationA || +bidA < 0)) {
                      _context5.next = 11;
                      break;
                    }
                  ...
                  case 11:
                    this.terminal.underlying.reset();
                    return _context5.abrupt("return", +bidA);
        ...
        key: "assignment1BPlayerB",
        value: function assignment1BPlayerB(valuationB) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0,
          /*#__PURE__*/
            ...
            return regeneratorRuntime.wrap(function _callee6$(_context6) {
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
                    this.printToTerminal("Player B, you are assigned the random valuation of ".concat(valuationB, "."));
                    _context6.next = 3;
                    return this.takeInputFromTerminal('How much would you like to bid?: ');
                  ...
                  case 4:
                    if (!(isNaN(+bidB) || +bidB > valuationB || +bidB < 0)) {
                      _context6.next = 11;
                      break;
                    }
                  ...
                  case 11:
                    this.terminal.underlying.reset();
                    return _context6.abrupt("return", +bidB);
        ...
        key: "assignment2A",
        value: function assignment2A() {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0,
          /*#__PURE__*/
          regeneratorRuntime.mark(function _callee7() {
            var _this11 = this;

            var players, numberOfRounds, amountReceived, rateOfReturn, contributions, round, roundTotalContribution, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, player, playerContribution, _i20, _Object$keys, _player, contribution;
            ...
            return regeneratorRuntime.wrap(function _callee7$(_context7) {
              while (1) {
                switch (_context7.prev = _context7.next) {
                  case 0:
                    this.terminal.underlying.reset();
                    players = ['AHMET', 'CEREN', 'GUL SENA', 'HASAN CAN'];
                  ...
                  case 8:
                    ...
                    _context7.prev = 13;
                    _iterator = players[Symbol.iterator]();
                  ...
                  case 15:
                    ...
                    player = _step.value;
                    this.printToTerminal("Each player is given $".concat(amountReceived));
                    _context7.next = 20;
                    return this.takeInputFromTerminal("Player ".concat(player, " how much do you like to contribute to the project: "));

                  case 20:
                    playerContribution = _context7.sent;

                  case 21:
                    if (!(isNaN(+playerContribution) || +playerContribution > amountReceived || +playerContribution < 0)) {
                      _context7.next = 28;
                      break;
                    }
                  ...
                  case 48:
                    for (_i20 = 0, _Object$keys = Object.keys(contributions); _i20 < _Object$keys.length; _i20++) {
                      _player = _Object$keys[_i20];
                      contribution = contributions[_player][round];
                      this.printToTerminal("".concat(_player, " contributes ").concat(contribution, " to the water purification project.\n\t").concat(_player, " receives$").concat(amountReceived - contribution + roundTotalContribution * rateOfReturn, " payoff."));
                    }

                    this.printToTerminal("The group receives a benefit of ".concat(roundTotalContribution * rateOfReturn));
            ...
            }, _callee7, this, [[13, 36, 40, 48], [41,, 43, 47]]);
          }));
        }
      }, {
        key: "assignment2B",
        value: function assignment2B() {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0,
          /*#__PURE__*/
          regeneratorRuntime.mark(function _callee8() {
            var _this12 = this;

            var players, numberOfBalls, redBallRatio, prize, playerGuesses, payoffs, jar, _i21, _players, player, ball, guess;
              ...
              while (1) {
                switch (_context8.prev = _context8.next) {
                  case 0:
                    this.terminal.underlying.reset();
                    players = ['AHMET', 'CEREN', 'GUL SENA', 'HASAN CAN'];
                    this.printToTerminal("Players in the game: \n".concat(players.join(', '))); // const

                    numberOfBalls = 100;
                    redBallRatio = 0.4;
                    prize = 20;
                    playerGuesses = new Object();
                    payoffs = new Object();
                    jar = Array(numberOfBalls).fill(null).map(function (x, i) {
                      return i < numberOfBalls * redBallRatio ? 'red' : 'blue';
                    });
                    _i21 = 0, _players = players;

                  case 10:
                    if (!(_i21 < _players.length)) {
                      _context8.next = 29;
                      break;
                    }

                    player = _players[_i21];
                    this.terminal.underlying.reset();
                    Object.keys(playerGuesses).forEach(function (playerName) {
                      _this12.printToTerminal("".concat(playerName, "'s choice is ").concat(playerGuesses[playerName]));
                    });
                    ball = jar[this.getRandomInt(0, jar.length)];
                    this.printToTerminal("".concat(player, ", your random ball is ").concat(ball));
                    _context8.next = 18;
                    return this.takeInputFromTerminal("".concat(player, " make a guess: "));

                  case 18:
                    guess = _context8.sent;

                  case 19:
                    if (!(guess !== 'red' && guess !== 'blue')) {
                      _context8.next = 25;
                      break;
                    }
                  ...
                  case 29:
                    ...
                    players.forEach(function (player) {
                      ...
                      _this12.printToTerminal("".concat(player, " earns ").concat(payoffs[player], "."));
                    });
        ...
        key: "invalidAssignmentKey",
        value: function invalidAssignmentKey() {
          this.terminal.underlying.reset();
          this.printToTerminal('You entered a wrong assignment key, please check the url.');
        }
      }, {
        key: "printToTerminal",
        value: function printToTerminal(message) {
          var _this13 = this;

          var end = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '\r\n';
          this.terminal.write(message + end);
          requestAnimationFrame(function () {
            return _this13.lastLinePrintYPosition = _this13.terminal.underlying.buffer.cursorX;
          });
        }
      }, {
        key: "takeInputFromTerminal",
        value: function takeInputFromTerminal(prompt) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0,
          /*#__PURE__*/
              ...
              while (1) {
                switch (_context9.prev = _context9.next) {
                  case 0:
                    ...
                    return _context9.abrupt("return", this.lastInputSubject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1)).toPromise());
    ...
    ConsoleAssignmentComponent.ɵfac = function ConsoleAssignmentComponent_Factory(t) {
      return new (t || ConsoleAssignmentComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]));
    };

    ConsoleAssignmentComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      type: ConsoleAssignmentComponent,
      selectors: [["app-console-assignment"]],
      viewQuery: function ConsoleAssignmentComponent_Query(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵloadQuery"]()) && (ctx.terminal = _t.first);
        }
      },
      decls: 2,
      vars: 0,
      consts: [["term", ""]],
      template: function ConsoleAssignmentComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "ng-terminal", null, 0);
        }
      },
      directives: [ng_terminal__WEBPACK_IMPORTED_MODULE_5__["NgTerminalComponent"]],
      styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2Fzc2lnbm1lbnQtZW11bGF0b3IvY29tcG9uZW50cy9jb25zb2xlLWFzc2lnbm1lbnQvY29uc29sZS1hc3NpZ25tZW50LmNvbXBvbmVudC5zY3NzIn0= */"]
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ConsoleAssignmentComponent, [{
...
//# sourceMappingURL=assignment-emulator-assignment-emulator-module-es5.js.map